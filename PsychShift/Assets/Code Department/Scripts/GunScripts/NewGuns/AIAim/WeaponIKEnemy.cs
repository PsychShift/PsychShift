...
{
    public EnemyGunSelector enemyGunSelector;

    public float iterations = 10;
    ...
    {
        Vector3 targetDirection = (targetTransform.position + Vector3.up*2f) - aimTransform.position;
        ...
        {
            blendOut += (distanceLimit - targetDistance) / 50f;
        }
